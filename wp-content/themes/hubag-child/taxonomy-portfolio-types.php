<?php
/**
 * Taxonomy Template: Portfolio Types
 *
 * @package BeTheme
 * @version 1.0
 */
...
.portfolio-header .term-description {
    max-width: 800px;
    margin: 20px auto 0;
    color: #6c757d;
}
            ...
            <div class="container">
                                    ...
                                    <article id="post-<?php the_ID(); ?>" <?php post_class('portfolio-item'); ?>>
                                        ...
                                        <div class="portfolio-content">
                                            ...
                                            <a href="<?php the_permalink(); ?>" class="portfolio-readmore">
                                                <i class="fas fa-arrow-right"></i> Czytaj więcej
                                            </a>
                                        </div>
                                    </article>
                                </div>
                ...
                <?php else : ?>
                    <div class="no-portfolio-posts">
                        <h3>Przepraszamy, ale aktualnie w tej kategorii nie ma żadnych wpisów.</h3>
                        <p>Wróć za jakiś czas albo wróć teraz do</p>
                        <a href="<?php echo esc_url(home_url()); ?>" class="back-to-home">
                            <i class="fas fa-home"></i> Strony Głównej
                        </a>
                    </div>
                <?php endif; ?>
