...
function kodydobody(){
  ?>
	<!-- START PASEK WYSUWANY -->
 <div id="panel">
    <div id="titlepanel">
        POGOTOWIE ELEKTRYCZNE 24h
    </div>
    <div id="contentpanel">
        <h3 style="text-align: center; color: white; margin-bottom: 0px;">Pogotowie Wrocław/Trzebnica</h3><br>
		<h4 class="pogotowiefont" style="margin-bottom: 0px;"><i class="icon-phone"></i> <a href="tel:+48691594820">+48 691 594 820</a></h4>
		<h4 class="pogotowiefont" style="margin-bottom: 0px; padding-bottom: 0px;"><i class="icon-mail-line"></i> <a href="mailto:biuro@trzebnica-elektryk.pl">biuro@trzebnica-elektryk.pl</a></h4><br>
</div>
	</div>
  <!-- END PASEK WYSUWANY -->
