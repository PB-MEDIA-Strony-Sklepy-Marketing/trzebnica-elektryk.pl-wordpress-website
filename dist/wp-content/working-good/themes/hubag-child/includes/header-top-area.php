...
<div id="Top_bar">
	...
	<div class="container">
		<div class="column one">
			...
			<div class="row align-items-center odstepgora voltmont-hero-buttons fade-in-up delay-4 mt-5 mb-5 nodisplayphonetablet"><a href="#modal-opened" class="btn-hero btn-hero-primary" id="modal-closed">Zam贸w rozmow臋</a></div>
